...
<mt-loadmore :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore">
	<div class="det-keyinfo" dataTie = "ab">
		...
		<!--详情页-->
		<!--<mt-loadmore :top-method="loadTop" ref="loadmore2">-->
		<div class="details-img" ref="detImgHeight" v-if="isShow">
...
//				this.$refs.detImgHeight.offsetHeight = this.$store.state.scrollTop.detImgScrollT;
>>>>>>> master
			}
		},
		components : {
...
=======
			this.calcSize;
			if(this.isShow) this.scrollTop = this.$refs.detImgHeight.offsetTop;
>>>>>>> master
		}
	}
</script>